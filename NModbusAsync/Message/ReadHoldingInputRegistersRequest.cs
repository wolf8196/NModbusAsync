...
namespace NModbusAsync.Message
{
    ...
    {
        internal ReadHoldingInputRegistersRequest()
        {
        }

        internal ReadHoldingInputRegistersRequest(byte functionCode, byte slaveAddress, ushort startAddress, ushort numberOfPoints)
